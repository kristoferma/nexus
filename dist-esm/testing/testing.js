...
export async function createTestContext(opts) {
    ...
    const layout = rightOrFatal(await Layout.create({ entrypointPath: opts === null || opts === void 0 ? void 0 : opts.entrypointPath, projectRoot: opts === null || opts === void 0 ? void 0 : opts.projectRoot }));
