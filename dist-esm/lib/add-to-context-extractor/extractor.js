...
import { findModulesThatImportModule, getAbsoluteImportPath, isMergableUnion, mergeUnionTypes, unwrapMaybePromise, } from '../tsc';
 ...
 */
export function extractContextTypes(program, defaultTypes = { typeImports: [], types: [] }) {
