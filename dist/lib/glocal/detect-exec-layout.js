...
function detectExecLayout(input) {
    ...
    let projectDir = null;
    try {
        projectDir = (_b = fs_1.findFileRecurisvelyUpwardSync('package.json', { cwd })) === null || _b === void 0 ? void 0 : _b.dir;
    }
    catch (e) { }
    if (!projectDir) {
        return {
    ...
    try {
         ...
         */
        const toolPackageJsonPath = utils_1.requireResolveFrom(`${input.depName}/package.json`, projectDir);
