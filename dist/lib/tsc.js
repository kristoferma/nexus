...
exports.findModulesThatImportModule = exports.getAbsoluteImportPath = exports.mergeUnionTypes = exports.isMergableUnion = exports.unwrapMaybePromise = exports.registerTypeScriptTranspile = exports.transpileModule = exports.emitTSProgram = exports.getTSIncrementalFilePath = exports.deleteTSIncrementalFile = exports.createTSProject = void 0;
 ...
 */
function createTSProject(layout, options) {
    ...
    return Either_1.right(project);
}
exports.createTSProject = createTSProject;
 ...
 */
function emitTSProgram(project, // ts.EmitAndSemanticDiagnosticsBuilderProgram,
layout, options) {
    var _a, _b;
...
function registerTypeScriptTranspile(compilerOptions) {
    ...
    sourceMapSupport.install({
        ...
        retrieveFile(path) {
            var _a;
            return ((_a = outputCache.get(slash_1.default(path))) === null || _a === void 0 ? void 0 : _a.content) || '';
        },
    });
    /**
    ...
    pirates_1.addHook((source, fileName) => {
        ...
        const normalizedFileName = slash_1.default(fileName);
 ...
 */
function mergeUnionTypes(type) {
    const unionTypes = type.getUnionTypes();
    if (lodash_1.default.isEmpty(unionTypes))
        return '{ }';
    const stringifiedProps = lodash_1.default.chain(unionTypes)
        .reduce((acc, u) => {
 ...
 */
function findModulesThatImportModule(project, id) {
    var _a, _b;
    const data = [];
...
exports.findModulesThatImportModule = findModulesThatImportModule;
/**
